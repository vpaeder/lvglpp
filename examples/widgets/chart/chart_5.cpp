...
namespace lvgl::examples {
    ...
    static const std::vector<lv_coord_t> ecg_sample = {
    ...
    static void slider_x_event_cb(Event & e) {
        auto obj = e.get_target<Slider>();
        int32_t v = obj.get_value();
        chart->set_zoom_x(v);
    }

    static void slider_y_event_cb(Event & e) {
        auto obj = e.get_target<Slider>();
        int32_t v = obj.get_value();
        chart->set_zoom_y(v);
    }
    ...
    void chart_5() {
        auto root = scr_act();
        chart = std::make_shared<Chart>(root);

        chart->set_size(200, 150);
        chart->align(LV_ALIGN_CENTER, -30, -30);
        chart->set_range(LV_CHART_AXIS_PRIMARY_Y, -1000, 1000);
        ...
        slider_y.align_to(*chart, LV_ALIGN_OUT_RIGHT_MID, 20, 0);
    }
}