...
namespace lvgl::misc {
    ...
    #if LV_USE_USER_DATA
    template<class T> void StyleTransition::set_user_data(const T & arg) {
    ...
    Style::Style() {
        this->lv_obj = LvPointerType(new lv_style_t{});
    }
    ...
    void Style::set_text_font(const Font & value) {
        lv_style_set_text_font(this->raw_ptr(), value.raw_ptr());
    }
