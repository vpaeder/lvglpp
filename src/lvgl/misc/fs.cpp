...
namespace lvgl::misc {
    void FileSystem::initialize(char letter) {
        ...
        this->lv_obj = LvPointerType(new lv_fs_drv_t{});
    ...
    File::File() {
        this->lv_obj = LvPointerType(new lv_fs_file_t{});
    }
    ...
    Directory::Directory() {
        this->lv_obj = LvPointerType(new lv_fs_dir_t{});
    }
