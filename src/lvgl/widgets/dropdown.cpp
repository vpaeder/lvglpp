...
namespace lvgl::widgets {
    ...
    void Dropdown::set_options_static(const std::shared_ptr<char> options) {
        lv_dropdown_set_options_static(this->raw_ptr(), options.get());
    }
    ...
    void Dropdown::set_symbol(const std::shared_ptr<void> symbol) {
        lv_dropdown_set_symbol(this->raw_ptr(), symbol.get());
    }
    ...
    std::shared_ptr<const char> Dropdown::get_text() const {
        return std::shared_ptr<const char>(lv_dropdown_get_text(const_cast<lv_cls_ptr>(this->raw_ptr())));
    }

    std::shared_ptr<const char> Dropdown::get_options() const {
        return std::shared_ptr<const char>(lv_dropdown_get_options(const_cast<lv_cls_ptr>(this->raw_ptr())));
    }
    ...
    std::shared_ptr<const char> Dropdown::get_symbol() const {
        return std::shared_ptr<const char>(lv_dropdown_get_symbol(const_cast<lv_cls_ptr>(this->raw_ptr())));
