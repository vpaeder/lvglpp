...
namespace lvgl::widgets {
    ...
    public:
        ...
        /** \fn uint16_t get_x_start_point(std::shared_ptr<lv_chart_series_t> ser) const
         ...
         */
        uint16_t get_x_start_point(std::shared_ptr<lv_chart_series_t> ser) const;

        /** \fn lv_point_t get_point_pos_by_id(std::shared_ptr<lv_chart_series_t> ser, uint16_t id) const;
         *  \brief Gets coordinates of point with given index.
         *  \param ser: pointer to a series instance.
         *  \param id: index of point.
         *  \returns coordinates of point.
         */
        lv_point_t get_point_pos_by_id(std::shared_ptr<lv_chart_series_t> ser, uint16_t id) const;
        ...
        /** \fn std::shared_ptr<lv_chart_series_t> add_series(lv_color_t color, lv_chart_axis_t axis)
         ...
         */
        std::shared_ptr<lv_chart_series_t> add_series(lv_color_t color, lv_chart_axis_t axis);

        /** \fn void remove_series(std::shared_ptr<lv_chart_series_t> ser)
         *  \brief Removes given series from chart.
         *  \param ser: pointer to a series instance.
         */
        void remove_series(std::shared_ptr<lv_chart_series_t> ser);

        /** \fn void hide_series(std::shared_ptr<lv_chart_series_t> ser)
         *  \brief Hides given series.
         *  \param ser: pointer to a series instance.
         */
        void hide_series(std::shared_ptr<lv_chart_series_t> ser);

        /** \fn void show_series(std::shared_ptr<lv_chart_series_t> ser)
         *  \brief Makes given series visible.
         *  \param ser: pointer to a series instance.
         */
        void show_series(std::shared_ptr<lv_chart_series_t> ser);

        /** \fn void set_series_color(std::shared_ptr<lv_chart_series_t> ser, lv_color_t color)
         *  \brief Sets series color.
         *  \param ser: pointer to a series instance.
         *  \param color: desired color.
         */
        void set_series_color(std::shared_ptr<lv_chart_series_t> ser, lv_color_t color);

        /** \fn void set_x_start_point(std::shared_ptr<lv_chart_series_t> ser, uint16_t id)
         *  \brief Defines which point of given series is considered as first point.
         *  \param ser: pointer to a series instance.
         *  \param id: index of first point.
         */
        void set_x_start_point(std::shared_ptr<lv_chart_series_t> ser, uint16_t id);

        /** \fn std::shared_ptr<lv_chart_series_t> get_next_series(std::shared_ptr<lv_chart_series_t> ser) const
         *  \brief Gets series following given series.
         *  \param ser: pointer to a series instance.
         *  \returns a pointer to the next series.
         */
        std::shared_ptr<lv_chart_series_t> get_next_series(std::shared_ptr<lv_chart_series_t> ser) const;

        /** \fn std::shared_ptr<lv_chart_cursor_t> add_cursor(lv_color_t color, lv_dir_t dir)
         ...
         */
        std::shared_ptr<lv_chart_cursor_t> add_cursor(lv_color_t color, lv_dir_t dir);

        /** \fn void set_cursor_pos(std::shared_ptr<lv_chart_cursor_t> cursor, const lv_point_t & pos)
         *  \brief Sets cursor position.
         *  \param cursor: pointer to a cursor instance.
         *  \param pos: coordinates.
         */
        void set_cursor_pos(std::shared_ptr<lv_chart_cursor_t> cursor, lv_point_t & pos);

        /** \fn void set_cursor_point(std::shared_ptr<lv_chart_cursor_t> cursor, std::shared_ptr<lv_chart_series_t> ser, uint16_t id)
         *  \brief Sets cursor position on series point.
         *  \param cursor: pointer to a cursor instance.
         *  \param ser: pointer to a series instance.
         *  \param id: index of point.
         */
        void set_cursor_point(std::shared_ptr<lv_chart_cursor_t> cursor, std::shared_ptr<lv_chart_series_t> ser, uint16_t id);

        /** \fn lv_point_t get_cursor_point(std::shared_ptr<lv_chart_cursor_t> cursor) const
         *  \brief Gets coordinates of given cursor.
         *  \param cursor: pointer to a cursor instance.
         *  \returns coordinates of cursor.
         */
        lv_point_t get_cursor_point(std::shared_ptr<lv_chart_cursor_t> cursor) const;

        /** \fn void set_all_value(std::shared_ptr<lv_chart_series_t> ser, lv_coord_t value);
         *  \brief Sets all points of a series to the given value.
         *  \param ser: pointer to a series instance.
         *  \param value: value to set.
         */
        void set_all_value(std::shared_ptr<lv_chart_series_t> ser, lv_coord_t value);

        /** \fn void set_next_y_value(std::shared_ptr<lv_chart_series_t> ser, lv_coord_t value)
         *  \brief Sets next point's y coordinate of a series to given value.
         *  \param ser: pointer to a series instance.
         *  \param value: value to set.
         */
        void set_next_y_value(std::shared_ptr<lv_chart_series_t> ser, lv_coord_t value);

        /** \fn void set_next_xy_value(std::shared_ptr<lv_chart_series_t> ser, lv_coord_t x_value, lv_coord_t y_value)
         *  \brief Sets next point of a series to given values.
         *  \param ser: pointer to a series instance.
         *  \param x_value: value along x axis.
         *  \param y_value: value along y axis.
         */
        void set_next_xy_value(std::shared_ptr<lv_chart_series_t> ser, lv_coord_t x_value, lv_coord_t y_value);

        /** \fn void set_y_value_by_id(std::shared_ptr<lv_chart_series_t> ser, uint16_t id, lv_coord_t value)
         *  \brief For given series, sets y coordinate of point with given index to given value.
         *  \param ser: pointer to a series instance.
         *  \param id: point index.
         *  \param value: value to set.
         */
        void set_y_value_by_id(std::shared_ptr<lv_chart_series_t> ser, uint16_t id, lv_coord_t value);

        /** \fn void set_xy_value_by_id(std::shared_ptr<lv_chart_series_t> ser, uint16_t id, lv_coord_t value)
         ...
         *  \param y_value: value along y axis.
         */
        void set_xy_value_by_id(std::shared_ptr<lv_chart_series_t> ser, uint16_t id, lv_coord_t x_value, lv_coord_t y_value);

        /** \fn void set_ext_y_array(std::shared_ptr<lv_chart_series_t> ser, std::vector<lv_coord_t> array)
         *  \brief Sets series y values from given array.
         *  \param ser: pointer to a series instance.
         *  \param array: values to set.
         */
        void set_ext_y_array(std::shared_ptr<lv_chart_series_t> ser, std::vector<lv_coord_t> array);

        /** \fn void set_ext_x_array(std::shared_ptr<lv_chart_series_t> ser, std::vector<lv_coord_t> array)
         *  \brief Sets series x values from given array.
         *  \param ser: pointer to a series instance.
         *  \param array: values to set.
         */
        void set_ext_x_array(std::shared_ptr<lv_chart_series_t> ser, std::vector<lv_coord_t> array);
