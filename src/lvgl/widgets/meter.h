...
namespace lvgl::widgets {
    ...
    public:
         ...
         */
        std::shared_ptr<lv_meter_scale_t> add_scale();

        /** \fn void set_scale_ticks(std::shared_ptr<lv_meter_scale_t> scale, uint16_t cnt,
         ...
         */
        void set_scale_ticks(std::shared_ptr<lv_meter_scale_t> scale, uint16_t cnt,
                             uint16_t width, uint16_t len, lv_color_t color);

        /** \fn void set_scale_major_ticks(std::shared_ptr<lv_meter_scale_t> scale, uint16_t nth,
         ...
         */
        void set_scale_major_ticks(std::shared_ptr<lv_meter_scale_t> scale, uint16_t nth,
                                   uint16_t width, uint16_t len, lv_color_t color, int16_t label_gap);
        
        /** \fn void set_scale_range(std::shared_ptr<lv_meter_scale_t> scale, int32_t min,
         ...
         */
        void set_scale_range(std::shared_ptr<lv_meter_scale_t> scale, int32_t min,
                             int32_t max, uint32_t angle_range, uint32_t rotation);
        
        /** \fn std::shared_ptr<lv_meter_indicator_t> add_needle_line(std::shared_ptr<lv_meter_scale_t> scale,
         ...
         */
        std::shared_ptr<lv_meter_indicator_t> add_needle_line(std::shared_ptr<lv_meter_scale_t> scale,
                                                              uint16_t width, lv_color_t color, int16_t r_mod);
        
        /** \fn std::shared_ptr<lv_meter_indicator_t> add_needle_img(std::shared_ptr<lv_meter_scale_t> scale,
         *                                                           std::shared_ptr<void> src,
         *                                                           lv_coord_t pivot_x, lv_coord_t pivot_y);
         *  \brief Adds a needle image indicator to the meter.
         *  \param scale: pointer to a scale object.
         *  \param src: pointer to an image buffer or a path.
         *  \param pivot_x: horizontal coordinate of pivot point.
         *  \param pivot_y: vertical coordinate of pivot point.
         *  \returns a pointer to the indicator object.
         */
        std::shared_ptr<lv_meter_indicator_t> add_needle_img(std::shared_ptr<lv_meter_scale_t> scale,
                                                             std::shared_ptr<void> src,
                                                             lv_coord_t pivot_x, lv_coord_t pivot_y);
        
        /** \fn std::shared_ptr<lv_meter_indicator_t> add_arc(std::shared_ptr<lv_meter_scale_t> scale,
         ...
         *  \returns a pointer to the indicator object.
         */
        std::shared_ptr<lv_meter_indicator_t> add_arc(std::shared_ptr<lv_meter_scale_t> scale,
                                                      uint16_t width, lv_color_t color,
                                                      int16_t r_mod);
        
        /** \fn std::shared_ptr<lv_meter_indicator_t> add_scale_lines(std::shared_ptr<lv_meter_scale_t> scale,
         ...
         *  \returns a pointer to the indicator object.
         */
        std::shared_ptr<lv_meter_indicator_t> add_scale_lines(std::shared_ptr<lv_meter_scale_t> scale,
                                                              lv_color_t color_start, lv_color_t color_end,
                                                              bool local, int16_t width_mod);
        
        /** \fn void set_indicator_value(std::shared_ptr<lv_meter_indicator_t> indic, int32_t value)
         *  \brief Sets the value of an indicator.
         *  \param indic: pointer to an indicator object.
         *  \param value: value to set.
         */
        void set_indicator_value(std::shared_ptr<lv_meter_indicator_t> indic, int32_t value);

        /** \fn void set_indicator_start_value(std::shared_ptr<lv_meter_indicator_t> indic, int32_t value)
         *  \brief Sets the start value of an indicator.
         *  \param indic: pointer to an indicator object.
         *  \param value: value to set.
         */
        void set_indicator_start_value(std::shared_ptr<lv_meter_indicator_t> indic, int32_t value);

        /** \fn void set_indicator_end_value(std::shared_ptr<lv_meter_indicator_t> indic, int32_t value)
         *  \brief Sets the end value of an indicator.
         *  \param indic: pointer to an indicator object.
         *  \param value: value to set.
         */
        void set_indicator_end_value(std::shared_ptr<lv_meter_indicator_t> indic, int32_t value);
