...
namespace lvgl::widgets {
    ...
    public:
        ...
        /** \fn const std::shared_ptr<const char> get_placeholder_text() const
         *  \brief Gets placeholder text.
         *  \returns a pointer to the placeholder text.
         */
        const std::shared_ptr<const char> get_placeholder_text() const;
        ...
        /** \fn const std::shared_ptr<const char> get_accepted_chars() const
         *  \brief Gets the list of accepted characters.
         *  \returns a pointer to the list of accepted characters.
         */
        const std::shared_ptr<const char> get_accepted_chars() const;
