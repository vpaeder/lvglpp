...
namespace lvgl::widgets {
    ...
    const std::shared_ptr<const char> TextArea::get_text() const {
        return std::shared_ptr<const char>(
            lv_textarea_get_text(const_cast<lv_cls_ptr>(
                const_cast<lv_cls_ptr>(this->raw_ptr()))));
    }

    const std::shared_ptr<const char> TextArea::get_placeholder_text() const {
        return std::shared_ptr<const char>(
    ...
    const std::shared_ptr<const char> TextArea::get_accepted_chars() const {
        return std::shared_ptr<const char>(
            lv_textarea_get_accepted_chars(const_cast<lv_cls_ptr>(this->raw_ptr())));
    }
