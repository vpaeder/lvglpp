...
namespace lvgl::widgets {
    ...
    public:
        ...
        /** \fn void set_text_static(const std::shared_ptr<char> text)
         *  \brief Sets label text. String must remain allocated.
         *  \param text: text to set.
         */
        void set_text_static(const std::shared_ptr<char> text);
