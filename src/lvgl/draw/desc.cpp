...
namespace lvgl::draw {
    ...
    RectangleDrawDescriptor::RectangleDrawDescriptor() {
        this->lv_obj = LvPointerType(new lv_draw_rect_dsc_t{});
    ...
    LabelDrawDescriptor::LabelDrawDescriptor() {
        this->lv_obj = LvPointerType(new lv_draw_label_dsc_t{});
    ...
    ImageDrawDescriptor::ImageDrawDescriptor() {
        this->lv_obj = LvPointerType(new lv_draw_img_dsc_t{});
    ...
    LineDrawDescriptor::LineDrawDescriptor() {
        this->lv_obj = LvPointerType(new lv_draw_line_dsc_t{});
    ...
    ArcDrawDescriptor::ArcDrawDescriptor() {
        this->lv_obj = LvPointerType(new lv_draw_arc_dsc_t{});
